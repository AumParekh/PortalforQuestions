...
SPECS = [
    ...
    dict(
        ...
        model='Backward induction, zero-coupon bond', model_code='zero_backward',
        rule=r"At each node $V = [0.5 \times (V_u / (1 + r))] + [0.5 \times (V_d / (1 + r))]$, discounting at that node's own one-year rate; the zero pays \$1 at year 2",
    ...
    dict(
        ...
        rule=r'Add 20 bp to each one-year rate at the next node, then $V = \frac{0.5\,V_u + 0.5\,V_d}{1 + r}$ at every node; the zero pays \$1 at year 2',
