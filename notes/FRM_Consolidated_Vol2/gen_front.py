...
BOOK={'MR':'Market Risk','LR':'Liquidity \& Treasury','IM':'Investment Mgmt'}
...
A(r'{\small\color{FRMGrey}All 52 readings from Market Risk, Liquidity \& Treasury Risk and Investment Management,')
...
A(r'{\Huge\bfseries\color{FRMNavy} Consolidated Volume II}\\[6pt]')
A(r'{\Large\bfseries\color{FRMNavy} Market Risk \textbullet\ Liquidity \& Treasury \textbullet\ Investment Mgmt}\\[12pt]')
...
A(r'{\bfseries\color{FRMNavy}Readings} & 52 \textbullet\ 18 Market Risk, 17 Liquidity \& Treasury, 17 Investment Mgmt\\[4pt]')
